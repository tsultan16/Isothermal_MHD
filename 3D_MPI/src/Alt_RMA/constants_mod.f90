...
!*************************************
INTEGER, PARAMETER :: nranks_x = 6  ! # of ranks along x direction
INTEGER, PARAMETER :: nranks_y = 6  ! # of ranks along y direction
INTEGER, PARAMETER :: nranks_z = 6  ! # of ranks along z direction
